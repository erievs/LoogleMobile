...
@dso_cache = dso_local local_unnamed_addr global [486 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 1502080000, ; hash 0x5987ec00, from name: libaot-LooglePlusMobile.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 2411537050, ; hash 0x8fbd229a, from name: aot-LooglePlusMobile
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-LooglePlusMobile.dll.so
		ptr null; void* handle (0x0)
	}, ; 267
	...
	%struct.DSOCacheEntry {
		i64 2568130016, ; hash 0x99128de0, from name: aot-LooglePlusMobile.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-LooglePlusMobile.dll.so
		ptr null; void* handle (0x0)
	}, ; 285
	...
	%struct.DSOCacheEntry {
		i64 3527141614, ; hash 0xd23be8ee, from name: libaot-LooglePlusMobile
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-LooglePlusMobile.dll.so
		ptr null; void* handle (0x0)
	}, ; 400
	...
	%struct.DSOCacheEntry {
		i64 4020646203, ; hash 0xefa6313b, from name: LooglePlusMobile.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-LooglePlusMobile.dll.so
		ptr null; void* handle (0x0)
	}, ; 455
	...
	%struct.DSOCacheEntry {
		i64 4150859645, ; hash 0xf769177d, from name: LooglePlusMobile
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-LooglePlusMobile.dll.so
		ptr null; void* handle (0x0)
	}, ; 473
...
@assembly_store_bundled_assemblies = dso_local local_unnamed_addr global [111 x %struct.AssemblyStoreSingleAssemblyRuntimeData] zeroinitializer, align 4
